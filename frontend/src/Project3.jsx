        ...
        <>
            ...
            <nav className={`navbar navbar-light bg-custom-blue p-4 fixed-top ${scrollDirection === "down" ? "hide" : "show"} ${isScrolled ? "navbar-scrolled" : ""}`}>
                <div className="container-fluid">
                    ...
                    <form className="d-flex ms-auto align-items-center">
                        ...
                        <a className="btn btn-outline-success ms-3" href="https://github.com/jacheng1/inventory-manager" target="_blank" rel="noopener noreferrer">
                            GitHub
                        </a>
            ...
            <div id="project" className="intro-section bg-custom-blue text-start text-light pt-5 pb-5 mt-5">
                <div className="container p-4">
                    ...
                    <h1 className="display-4 fw-bold text-gray">A full-stack inventory management application that stores user-defined items, each configurable by name and quantity.</h1>
                    <p className="text-gray">
                    ● Developed a full-stack application that stores user-defined entries, each manageable via manual CRUD operations
                    <br />
                    ● Integrated Llama 3 LLM via Groq API to generate recipe text based on documents stored in Firestore database
                    </p>
                </div>
            </div>
