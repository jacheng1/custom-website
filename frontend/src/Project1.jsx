...
function Project1() {
    ...
    return (
        <>
            ...
            <nav className={`navbar navbar-light bg-custom-blue p-4 fixed-top ${scrollDirection === "down" ? "hide" : "show"} ${isScrolled ? "navbar-scrolled" : ""}`}>
                <div className="container-fluid">
                    ...
                    <form className="d-flex ms-auto align-items-center">
                        <Link className="btn btn-outline-success ms-3" to="/" rel="noopener noreferrer">Back to Home</Link>
                        <a className="btn btn-outline-success ms-3" href="https://github.com/jacheng1/fabflix" target="_blank" rel="noopener noreferrer">
                            GitHub
                        </a>
            ...
            <div id="project" className="intro-section bg-custom-blue text-start text-light pt-5 pb-5 mt-5">
                <div className="container p-4">
                    ...
                    <h1 className="display-4 fw-bold text-gray">A full-stack e-commerce application built and deployed on AWS EC2, enabling users to browse, sort, and search for movies.</h1>
                    <p className="text-gray">
                    ● Built and deployed full-stack e-commerce app on AWS EC2, enabling users to browse, sort, and search movies
                    <br />
                    ● Integrated Apache load balancer, decreasing server response times by 10% and maintaining a 99.9% uptime
                    <br />
                    ● Scaled containerized app on Kubernetes cluster with multiple AWS instances, retaining sub-250 ms response time
                    <br />
                    ● Implemented full-text search and autocomplete, increasing content search efficiency
                    </p>
                </div>
            </div>
