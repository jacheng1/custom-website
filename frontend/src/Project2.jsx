        ...
        <>
            ...
            <nav className={`navbar navbar-light bg-custom-blue p-4 fixed-top ${scrollDirection === "down" ? "hide" : "show"} ${isScrolled ? "navbar-scrolled" : ""}`}>
                <div className="container-fluid">
                    ...
                    <form className="d-flex ms-auto align-items-center">
                        ...
                        <a className="btn btn-outline-success ms-3" href="https://github.com/jacheng1/search-engine" target="_blank" rel="noopener noreferrer">
                            GitHub
                        </a>
            ...
            <div id="project" className="intro-section bg-custom-blue text-start text-light pt-5 pb-5 mt-5">
                <div className="container p-4">
                    ...
                    <h1 className="display-4 fw-bold text-gray">A search engine, built from the ground up, that utilizes a corpus of over 55,000 web pages and achieves results in less than 300 ms.</h1>
                    <p className="text-gray">
                    ● Developed full-stack search engine utilizing corpus of 55,000+ web pages with query response times under 300 ms
                    <br />
                    ● Implemented inverted index for efficient query processing, enabling partial disk loading to minimize memory usage
                    <br />
                    ● Integrated ranked retrieval and tf-idf weighting scheme, enhancing relevance and accuracy of query results
                    </p>
                </div>
            </div>
